// Minimalistic black/white SVG icons
...
export const TargetIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11V8m0 0a3 3 0 10-3 3m3-3a3 3 0 00-3 3m0 0h3m4 0a7 7 0 11-7-7 7 7 0 017 7z" />
  </svg>
);
...
export const getIconForContent = (title: string, description: string): React.ReactNode => {
