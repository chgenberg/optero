...
export default function AIRecommendations({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="text-center">
            <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 px-2 leading-tight">
              ...
              <div className="flex gap-2 pb-2 min-w-max">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg font-medium transition-all duration-200 text-xs whitespace-nowrap ${
                      activeTab === tab.id
      ...
      <div className="w-full mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12">
        {/* Scenarios tab */}
        {activeTab === "scenarios" && (
          <div className="space-y-4 sm:space-y-6 animate-fade-in-up w-full max-w-4xl mx-auto">
            {scenarios.map((scenario, index) => (
              <div
                key={index}
                className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-100 shadow-lg sm:shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4 mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-900 text-white rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 sm:mb-3 uppercase tracking-wider">Situation</p>
                    <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">{scenario.situation}</p>
                  </div>
                  
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 sm:mb-3 uppercase tracking-wider">Lösning</p>
                    <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">{scenario.solution}</p>
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {scenario.tools.map((tool, i) => (
                        <span
                          key={i}
                          className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gray-900 text-white text-xs sm:text-sm rounded-lg hover:bg-gray-800 transition-colors cursor-pointer"
                        >
                          {tool}
                        </span>
                      ))}
        ...
        {activeTab === "tools" && (
          <div className="space-y-4 sm:space-y-6 animate-fade-in-up w-full max-w-4xl mx-auto">
            {recommendations.slice(0, 5).map((rec, index) => (
              <div
                key={index}
                className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-100 shadow-lg sm:shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer"
              ...
              >
                <div className="mb-4 sm:mb-6">
                  <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 sm:mb-4">
                        ...
                        <span className="text-xs sm:text-sm font-medium px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-900 text-white rounded-lg mt-2 sm:mt-0 self-start">
                          {rec.timeSaved}
                        </span>
                      </div>
                  ...
                  <div className="bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-gray-100 mb-3 sm:mb-4">
