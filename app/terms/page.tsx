            ...
            <section className="card p-8 animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  ...
                  <p>Email: <a href="mailto:ch.genberg@gmail.com" className="text-gray-900 underline">ch.genberg@gmail.com</a></p>
                  <p>Phone: <a href="tel:+46732305521" className="text-gray-900 underline">+46 732 30 55 21</a></p>
                </div>
              </div>
            </section>
