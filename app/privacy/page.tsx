          ...
          <div className="space-y-8">
            <section className="card p-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Business information (website, documents, bot configuration)</li>
            ...
            <section className="card p-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Provide personalized AI recommendations for your business</li>
                  <li>Design, build and deploy custom chatbots</li>
            ...
            <section className="card p-8 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="mt-4">
                  You can also use our self-service tools: <a href="/gdpr/exportera-data" className="text-gray-900 underline">Export your data</a> or <a href="/gdpr/radera-data" className="text-gray-900 underline">Delete your data</a>
                </p>
              </div>
            </section>
            ...
            <section className="card p-8 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="mt-4">
                  ...
                  We only use cookies with your consent through our cookie banner.
                </p>
              </div>
            </section>
